...
describe("App", () => {
  ...
  describe("Simple Store", () => {
    it("increments age by 1 on click", async () => {
      ...
      const incrementButton = section?.querySelector('input[value="Increment Age"]');
    ...
    it("updates name on submit", async () => {
      render(<App />);
      const section = getSimpleStoreSection();
      const nameInput = section?.querySelector('input[name="name"]') as HTMLInputElement;
    ...
    it("adds skill on submit", async () => {
      render(<App />);
      const section = getSimpleStoreSection();
      const skillInput = section?.querySelector('input[name="skill"]') as HTMLInputElement;
